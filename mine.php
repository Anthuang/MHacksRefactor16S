...
if (isset($_POST['id']) && !empty($_POST['id']) && isset($_POST['touser']) && !empty($_POST['touser'])) {
	$id = $_POST['id'];
	$touser = $_POST['touser'];
	$result = queryMysql('SELECT * FROM `Applications` WHERE `FromUser`="'.$username.'" AND `ToUser`="'.$touser.'" AND `MarkerIdx`="'.$id.'"');
	$num = $result->num_rows;
	if ($num > 0) {
		...
		$a2 = $row['Two'];
		$a3 = $row['Three'];
	} else if (isset($_POST['a1']) && !empty($_POST['a1']) && isset($_POST['a2']) && !empty($_POST['a2']) && isset($_POST['a3']) && !empty($_POST['a3'])) {
		$a1 = $_POST['a1'];
		$a2 = $_POST['a2'];
		$a3 = $_POST['a3'];
...
<form action="mine.php" method="post">
	...
	Question 1: <input type="text" value="$q1" id="q1" readonly="readonly"><input type="text" name="a1" value="$a1"><br>
	Question 2: <input type="text" value="$q2" id="q2" readonly="readonly"><input type="text" name="a2" value="$a2"><br>
	Question 3: <input type="text" value="$q3" id="q3" readonly="readonly"><input type="text" name="a3" value="$a3"><br>
